              ...
              <div class="row">
                <div class="row col-md-12">
                  <div
                    ...
                    :class="{
                      error: validation.hasError('doctorInfo.user.firstName'),
                    }"
                  >
                    ...
                    <small style="color: red">{{
                      validation.firstError("doctorInfo.user.firstName")
                    }}</small>
                  </div>
                  <div
                    class="col-md-6 flex-column"
                    :class="{
                      error: validation.hasError('doctorInfo.user.lastName'),
                    }"
                  >
                    ...
                    />
                    <small style="color: red">{{
                      validation.firstError("doctorInfo.user.lastName")
                    }}</small>
                  </div>
                </div>
                <div class="col-md-12 row">
                  <div
                    class="col-md-6 flex-column"
                    :class="{
                      error: validation.hasError('doctorInfo.user.birthDay'),
                    }"
                  >
                    ...
                    />
                    <small style="color: red">{{
                      validation.firstError("doctorInfo.user.birthDay")
                    }}</small>
                  </div>
                  <div
                    class="col-md-6 flex-column"
                    :class="{
                      error: validation.hasError('doctorInfo.user.gender'),
                    }"
                  >
                    <label>Gender</label>
                    ...
                    <small style="color: red">{{
                      validation.firstError("doctorInfo.user.gender")
                    }}</small>
                  </div>
                </div>
                ...
                <div class="col-md-12 row">
                  <div
                    class="col-md-6 flex-column"
                    :class="{
                      error: validation.hasError('doctorInfo.user.email'),
                    }"
                  >
                    ...
                    />
                    <small style="color: red">{{
                      validation.firstError("doctorInfo.user.email")
                    }}</small>
                  </div>
                  <div
                    class="col-md-6 flex-column"
                    :class="{
                      error: validation.hasError('doctorInfo.user.phoneNumber'),
                    }"
                  >
                    ...
                    />
                    <small style="color: red">{{
                      validation.firstError("doctorInfo.user.phoneNumber")
                    }}</small>
                  </div>
                </div>
                ...
                <div class="col-md-12 row">
                  <div
                    class="col-md-6 flex-column"
                    :class="{
                      error: validation.hasError('doctorInfo.experience'),
                    }"
                  >
                    <label>Address</label>
                    <input
                    ...
                    />
                    <small style="color: red">{{
                      validation.firstError("doctorInfo.user.address")
                    }}</small>
                  </div>
                  <div
                    class="col-md-6 flex-column"
                  ...
                  >
                    ...
                    <input
                      ...
                      id="address"
                      placeholder="Address"
                      v-model="doctorInfo.user.identityCard"
                    />
                    <small style="color: red">{{
                      validation.firstError("doctorInfo.user.identityCard")
                    }}</small>
                  </div>
                </div>
                ...
                >
                  ...
                  <small style="color: red">{{
                    validation.firstError("doctorInfo.experience")
                  }}</small>
                </div>
...
export default {
  ...
  methods: {
    async GetDocById() {
      this.loader = true;
      await HTTP.get(
        `Doctor/GetDoctorById?doctorId=` + localStorage.getItem("DoctorId")
      ).then((res) => {
        this.loader = false;
        (this.doctorInfo.user = { ...res.data.user }),
          (this.doctorInfo = { ...res.data });
        const imageSrc = this.doctorInfo.user.image;
    ...
    changeAvatar() {
      const userId = this.doctorInfo.user.id;
