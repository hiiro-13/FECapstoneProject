              ...
              <div class="row">
                <div class="row col-md-12">
                  ...
                  >
                    ...
                    <input
                      ...
                      v-model="technicianProfile.user.firstName"
                    />
                    <small style="color: red">{{
                      validation.firstError("technicianProfile.user.firstName")
                    }}</small>
                  </div>
                  <div
                    class="col-md-6 flex-column"
                    :class="{
                      error: validation.hasError(
                        'technicianProfile.user.lastName'
                      ),
                    }"
                  >
                    ...
                    <input
                      ...
                      v-model="technicianProfile.user.lastName"
                    />
                    <small style="color: red">{{
                      validation.firstError("technicianProfile.user.lastName")
                    }}</small>
                  </div>
                </div>
                <div class="col-md-12 row">
                  <div
                    ...
                    :class="{
                      error: validation.hasError(
                        'technicianProfile.user.birthDay'
                      ),
                    }"
                  >
                    ...
                    <Calendar
                      class="w-100"
                      id="birthday"
                      v-model="technicianProfile.user.birthDay"
                      dateFormat="dd/mm/yy"
                    />
                    <small style="color: red">{{
                      validation.firstError("technicianProfile.user.birthDay")
                    }}</small>
                  </div>
                  <div
                    class="col-md-6 flex-column"
                  ...
                  >
                    ...
                    <div class="flex flex-wrap gap-3 mt-3">
                      <div class="form-check">
                        <RadioButton
                          v-model="technicianProfile.user.gender"
                          inputId="maleGender"
                          value="Male"
                        />
                    ...
                    <small style="color: red">{{
                      validation.firstError("technicianProfile.user.gender")
                    }}</small>
                  </div>
                </div>
                ...
                <div class="col-md-12 row">
                  ...
                  >
                    ...
                    <input
                      ...
                      v-model="technicianProfile.user.email"
                    />
                    <small style="color: red">{{
                      validation.firstError("technicianProfile.user.email")
                    }}</small>
                  </div>
                  <div
                    class="col-md-6 flex-column"
                    :class="{
                      error: validation.hasError(
                        'technicianProfile.user.phoneNumber'
                      ),
                    }"
                  >
                    ...
                    <input
                      ...
                      v-model="technicianProfile.user.phoneNumber"
                    />
                    <small style="color: red">{{
                ...
                <div class="col-md-12 row">
                  ...
                  >
                    ...
                    <input
                      ...
                      id="address"
                      placeholder="Address"
                      v-model="technicianProfile.user.address"
                    />
                    <small style="color: red">{{
                      validation.firstError("technicianProfile.user.address")
                    }}</small>
                  </div>
                  <div
                    class="col-md-6 flex-column"
                    :class="{
                      error: validation.hasError(
                        'technicianProfile.user.identityCard'
                      ),
                    }"
                  >
                    ...
                    <input
                      ...
                      id="address"
                      placeholder="Address"
                      v-model="technicianProfile.user.identityCard"
                    />
                    <small style="color: red">{{
                      validation.firstError(
                        "technicianProfile.user.identityCard"
                ...
                <div
                  ...
                  :class="{
                    error: validation.hasError('technicianProfile.experience'),
                  }"
                >
                  ...
                  <div class="input-group">
                    <input
                      ...
                      v-model="technicianProfile.experience"
                    />
                    <span class="input-group-text">Year</span>
                  </div>
                  <small style="color: red">{{
                    validation.firstError("technicianProfile.experience")
                  }}</small>
                </div>

                <div class="d-flex justify-content-end">
                  <Button
                    @click="handleSubmit(this.technicianProfile.id)"
                    label="Save Changes"
                  />
                </div>
              </div>
...
export default {
  ...
  methods: {
    async GetTechnicianById() {
      this.loader = true;
      await HTTP.get(
        `Technician/GetTechnicianById?id=` +
          localStorage.getItem("MRITechnicianId")
      ).then((res) => {
        this.loader = false;
        (this.technicianProfile.user = { ...res.data.user }),
          (this.technicianProfile = { ...res.data });
        const imageSrc = this.technicianProfile.user.image;
    ...
    async handleSubmit(id) {
      ...
      if (success === true) {
        this.$confirm.require({
          ...
          accept: async () => {
            HTTP.put(
              "Technician/EditTechnician?id=" + id,
    ...
    changeAvatar() {
      const userId = this.technicianProfile.user.id;
